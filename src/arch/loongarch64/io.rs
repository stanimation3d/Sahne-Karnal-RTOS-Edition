...
// LoongArch'ta donanım erişimi tamamen MMIO yoluyla yapılır.
...
// LoongArch, MIPS'ten miras aldığı ve kendi geliştirdiği bariyer talimatlarına sahiptir.

/// Veri Senkronizasyon Bariyeri (DBAR - Data Barrier).
...
pub fn dbar() {
    unsafe {
        // dbar 0 (Tip 0, tüm bellek erişimi için tam bariyer)
        // LoongArch assembly: 'dbar 0'
        asm!("dbar 0", options(nomem, nostack));
    }
}

/// Talimat Senkronizasyon Bariyeri (IBAR - Instruction Barrier).
...
/// Genellikle sistem yazmaçlarına (CSR - Control Status Register) yazdıktan sonra kullanılır.
#[inline(always)]
pub fn ibar() {
    unsafe {
        // ibar 0 (Tip 0, tam talimat bariyeri)
        // LoongArch assembly: 'ibar 0'
...
/// KISA I/O GECİKMESİ
/// LoongArch'ta MMIO gecikmesi için genellikle bir Veri Bariyeri (DBAR) kullanılır.
#[inline(always)]
pub fn io_wait() {
    dbar();
}